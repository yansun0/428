...
let GROUPS_TOTAL = 3
let TRIALS_TOTAL = GROUPS_TOTAL * TRIALS_PER_GROUP
let TRIAL_TEXTS : [ String ] =
...
let TRIAL_GROUP_MODES : [ Int : [ TextMode ] ] =
    [ 0 : [ .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll,
            .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker,
            .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP ],
      1 : [ .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker,
            .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP,
            .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll ],
      2 : [ .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP, .RSVP,
            .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll, .Scroll,
            .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker, .Ticker ],
    ]
